...
This insight originated from the famous *Alpher–Bethe–Gamow ($\alpha\beta\gamma$) paper*, which provided the first theoretical prediction of the **cosmic background radiation** more than a decade before its accidental discovery by Arno Penzias and Robert Wilson in 1965 (<d-cite key="penzias1965cmb"></d-cite>). Once BBN concluded, these relic radiations permeated throughout the universe.
...
Shortly after recombination and decoupling, the universe entered a long and silent phase known as the **Dark Ages** — the period between recombination and the formation of the **first stars**. Although the name suggests a universe devoid of light, this was not entirely true. The CMBR still permeated space, and neutral hydrogen atoms emitted the characteristic $21\text{cm}$ spectral line<d-footnote>The $21\text{cm}$ radiation corresponds to the hyperfine transition of neutral hydrogen and serves as a crucial probe for mapping matter distribution during the Dark Ages.</d-footnote>. However, during this epoch, the spectral line of neutral hydrogen fell into the infrared region, and as the universe expanded, even the CMBR redshifted from visible to infrared wavelengths. This made the universe appear **dark**, aside from minor statistical fluctuations and faint background emissions.

## The Reionization Epoch

The Dark Ages ended with the formation of the **first stars**, around 150 million years after the Big Bang. This marked the beginning of the **Reionization Epoch**, which lasted for about one billion years. Over time, dark matter halos formed, and gravity drew ordinary (baryonic) matter into these halos, giving rise to the first galaxies. This era witnessed the transition from radiation to matter domination, and set the stage for the formation of large–scale structures that would shape the modern universe.

---

## Toward Structure Formation

The study of this era would be incomplete without discussing the role of dark matter, whose energy density at this time guided the universe toward **bottom–up** structure formation — small galaxies forming first and later merging into larger clusters.  

In the next blog post, we will explore the Large-Scale Structure (LSS) formation in greater depth and examine why the second most abundant constituent, dark matter, is essential for the existence of massive structures such as our own Milky Way Galaxy.
